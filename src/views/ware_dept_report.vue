...
<template>
    <div class="body">
        <div class="body-header">
            <div class="search-box">部门选择
                <Select class="search-input" v-model="reportdepar">
                    <Option v-for="item in deparList" :value="item.id" :key="item.id">{{ item.name }}</Option>
                </Select>
            </div>
           <!-- <div class="search-box">商品类型
                <Select class="search-input" v-model="reporttype">
